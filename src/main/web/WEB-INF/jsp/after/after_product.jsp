...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div>
                    <button class="btn btn-info"  name="showaddProduct">添加</button>
                    ...
                    <table class="table table-hover table-striped" style="margin-top: 10px;">
                        ...
                        <c:forEach items="${pageInfo.list}" var="product">
                            <tr align="center">
                                ...
                                <td align="center"><button class="btn btn-danger" productID="${product.id}" name="showDeleteProduct" >删除</button></td>
                            </tr>
                        </c:forEach>
                    </table>
